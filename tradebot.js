...
//            console.log("\nmy orders before filter:\n" + JSON.stringify(parsed_body, null, 2));
			myorders = parsed_body.filter(order => !ignore_my_asks || order.side == 'buy'); // mildly racy
//            console.log("\nmy orders after filter:\n" + JSON.stringify(myorders, null, 2));
			if (orderbook != null)
...
//        if (ignore_my_asks && orderstodelete[order].side == 'sell')
//            continue;
//		
